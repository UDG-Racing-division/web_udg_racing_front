...
export function Footer() {
  ...
  return <footer id="contact" ref={ref} className="bg-black border-t border-zinc-800 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          delay: 0.1
            ...
            duration: 0.5,
            delay: 0.2
          }} src="/logo_udgRacing.png" alt="UdG Racing Division" className="h-12 w-auto mb-4" />
            <motion.p initial={{
            opacity: 0
          }} animate={isInView ? {
            opacity: 1
            ...
            delay: 0.3
              ...
              Equip de competició de la Universitat de Girona dedicat a la
              innovació en motorsport.
            </motion.p>

            {/* Social links */}
            <div className="flex gap-4 mb-6">
              {socialLinks.map((social, index) => <motion.a key={social.label} href={social.href} target="_blank" rel="noopener noreferrer" aria-label={social.label} initial={{
              opacity: 0,
              scale: 0.8
            }} animate={isInView ? {
              opacity: 1,
          ...
          delay: 0.2
            ...
            <ul className="space-y-2">
              {quickLinks.map((link, index) => <motion.li key={link.label} initial={{
              opacity: 0,
              x: -10
            }} animate={isInView ? {
              opacity: 1,
          ...
          delay: 0.3
            ...
            <ul className="space-y-2 mb-6">
              {externalLinks.map((link, index) => <motion.li key={link.label} initial={{
              opacity: 0,
              x: -10
            }} animate={isInView ? {
              opacity: 1,
              ...
              delay: 0.4 + index * 0.05
                  ...
                  <motion.a href={link.href} target={link.external ? '_blank' : '_self'} rel={link.external ? 'noopener noreferrer' : undefined} whileHover={{
                x: 5
              }} transition={{
                type: 'spring',
                stiffness: 300
            ...
            delay: 0.6
              ...
              <div className="flex items-center gap-2 text-gray-400">
                ...
                <motion.a href="mailto:info@udgracingdivision.com" whileHover={{
                x: 3
              }} transition={{
                type: 'spring',
                stiffness: 300
        ...
        delay: 0.7
          ...
          <p>&copy; 2025 UdG Racing Division. Tots els drets reservats.</p>
